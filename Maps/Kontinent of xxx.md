...
```leaflet  
id: MainKontinent ### Must be unique with no spaces  
image: [[MainKontinent.png]] ### Link to the map image file. Do not add a ! in front of the image  
bounds: [[0,0], [1536, 1024]] ### Size of the map in px Height_y, Width_x. Ignore 0,0  
